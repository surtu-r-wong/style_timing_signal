...
relative return, 5-day rolling compound return, 20-day rolling z-score after the
20-day window is available, tanh(z / 2), then equal-weight average.
The output factor value is the same-day unsmoothed value.
"""
...
def calculate_contrast_equal_weight_signal(
    ...
    """Calculate contrast-style pair signals and unsmoothed factor value."""
    if lookback <= 0:
