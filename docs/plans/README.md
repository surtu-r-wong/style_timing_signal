...
| axes entry ticket batch 1（低波/动量/流动性/股息） | **ALL_FAIL**（当前功效下不可辨认，不等于无增量信息） | [entry-ticket 设计冻结 §0–3](2026-08-24-new-rotation-axes-entry-ticket.md)；[回填后重验预登记](2026-08-26-axes-pit-indicator-revalidation.md) | [2026-08-26 完整生产库重验 complete manifest](../../backtest/output/runs/20260826T222036-axes-ticket-ecf1907/manifest.json)；[machine verdict](../../backtest/output/runs/20260826T222036-axes-ticket-ecf1907/outputs/axis_ticket_verdict.json) | 08-24 run 作为前一版权威证据保留 | 新证据或更长评窗（受 stock_indicator 2015 起点约束）；股息轴贴线读数（偏 IC 0.157/p 0.065、与现役近正交）只作排队参考，重开须新预登记 |
| axes entry ticket batch 2（质量） | **ALL_FAIL**（当前功效下不可辨认，不等于无增量信息） | [批次二增量设计 §1–3](2026-08-24-quality-axis-entry-ticket-b2.md)；[回填后重验预登记](2026-08-26-axes-pit-indicator-revalidation.md) | [2026-08-26 完整生产库重验 complete manifest](../../backtest/output/runs/20260826T223022-axes-ticket-06776ab/manifest.json)；[machine verdict](../../backtest/output/runs/20260826T223022-axes-ticket-06776ab/outputs/axis_ticket_verdict.json) | 08-24 run 作为前一版权威证据保留 | 同批次一行；五轴全族仍为 0 过闸，重开任一轴须新证据/更长评窗+新预登记 |
