...
> 起草：2026-09-23
> 〔2026-09-23 晚注〕推送时刻随输入指数移交 data_manager 改为约 20:31（定时器 18:30 → 20:30，第 0 步等办公室日更到齐、
> 最迟 21:30）；体检行随之认 `OFFICE_*`（见 `docs/plans/2026-09-23-post-takeover-readonly-mode.md` §5）。正文不改，仍按 18:30 叙述。
