...
| 动量变换器(收官后 07-10 用户开题) | ✅ 已测不换:skip 跳月/长形成期死,**slope L20 同频稳健化全面不劣但 holdout 平手**,按预登记规则维持收益变换器(第三次确认);`2026-07-10-momentum-transform-scan-design.md` §7 | slope20 = 生产信号**第一替补**——若未来需要 regime 稳健性或重估因子秩序,`momentum_factor_fn` 一行复算 |
