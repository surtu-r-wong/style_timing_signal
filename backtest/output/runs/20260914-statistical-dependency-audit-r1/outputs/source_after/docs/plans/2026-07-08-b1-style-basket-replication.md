...
> **2026-09-14 统计依赖审计更正**：本项为相关性复现验收，未依赖max-T/min-P预测力检验。validation_all.csv与validation_U2.csv已于4445f84入库，后续审计“未入库”的说法错误；复现PASS仅约束历史相关验收，不证明全部PIT或数据修复问题已解决。 见[逐项审计](2026-09-14-statistical-dependency-audit.md)。下文数字作为历史记录保留。
