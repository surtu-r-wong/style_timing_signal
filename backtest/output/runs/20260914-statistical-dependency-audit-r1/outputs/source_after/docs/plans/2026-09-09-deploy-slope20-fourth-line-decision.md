...
> **2026-09-14 统计依赖审计更正**：采用记录为风险偏好选择，并未通过已校准的统计优势检验；早期slope变体的小p不是本部署点的证据。本文2024-2026为已复用历史验证窗。“与equal_weight同样未审空头”的括注也不准确：equal_weight路线A已审，slope20对称空头执行仍需单独验证。 见[逐项审计](2026-09-14-statistical-dependency-audit.md)。下文数字作为历史记录保留。
