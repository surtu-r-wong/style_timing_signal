...
> **2026-09-14 统计依赖审计更正**：本部署明确为风险偏好裁决，保留采用记录；不得追加引用演示网格p=0.007或在位者k=10赢家p=0.013作为部署点的统计证明。本审计不改变生产映射。 见[逐项审计](2026-09-14-statistical-dependency-audit.md)。下文数字作为历史记录保留。
...
- 空头通过 IC/IM 期货承载（blend 50/50），carry 已在引擎内按持仓方向计入；09-14更正：`2026-08-13-exec-price-audit.md`路线A已覆盖equal_weight空头，blend样本止于2026-04-29；最新两池执行另见09-14报告。
