...
> **2026-09-14参数追溯补注**：a2e19f0实际为07-02提交，不是6月。20/40/5早于7月扫描器，但首个快照已有raw/smooth和阈值优化，不能因此断言未经过历史选择。 见[参数历史](2026-09-14-incumbent-parameter-lineage.md)。

> **2026-09-14 统计依赖审计更正**：§4“校正只会更STOP/反向稳健”只涉及特定同零分布的选优校正比较，不构成对重建有效非平稳零分布后p变化方向的保证。保留不推进记录，撤回把非显著当无效的推论。 见[逐项审计](2026-09-14-statistical-dependency-audit.md)。下文数字作为历史记录保留。
